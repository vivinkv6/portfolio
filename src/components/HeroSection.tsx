...
const HeroSection: React.FC = React.memo(() => {
  return (
    <main className="h-screen w-full overflow-hidden bg-black text-white">
      <section className="container mx-auto relative h-[100dvh] mt-4 border border-white/10 w-full overflow-hidden rounded-2xl min-h-[600px]">
        ...
        <div className="relative bottom-0 z-[1] h-[400px] max-sm:h-[600px] w-screen  [mask-image:radial-gradient(100%_50%,white,transparent)] before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom_center,#3273ff,transparent_90%)] before:opacity-40 after:absolute">
